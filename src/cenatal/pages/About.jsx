...
//                   <div className="pb-5">
//                     <h1 className="display-5 text-capitalize">Cental <span
//                       className="text-primary">About</span></h1>
//                     <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet
//                       nemo expedita asperiores commodi accusantium at cum harum, excepturi, quia tempora
...
//                           <img src="img/about-icon-1.png" className="img-fluid w-50 h-50"
//                             alt="Icon" />
//                         </div>
...
//                       <div className="about-item-inner border p-4">
//                         <div className="about-icon mb-4">
//                           <img src="img/about-icon-2.png" className="img-fluid h-50 w-50"
//                             alt="Icon" />
//                         </div>
...
//                     </div>
//                   </div>
//                   <p className="text-item my-4">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
//                     Beatae, aliquam ipsum. Sed suscipit dolorem libero sequi aut natus debitis reprehenderit
//                     facilis quaerat similique, est at in eum. Quo, obcaecati in!
//                   </p>
//                   <div className="row g-4">
//                     <div className="col-lg-6">
...
//                         <p className="mb-2"><i className="fa fa-check-circle text-primary me-1" /> Morbi
//                           tristique senectus</p>
//                         <p className="mb-2"><i className="fa fa-check-circle text-primary me-1" /> A
//                           scelerisque purus</p>
//                         <p className="mb-2"><i className="fa fa-check-circle text-primary me-1" />
//                           Dictumst vestibulum</p>
//                         <p className="mb-0"><i className="fa fa-check-circle text-primary me-1" /> dio
//                           aenean sed adipiscing</p>
//                       </div>
//                     </div>
...
//               <h1 className="display-5 text-capitalize mb-3">Cental <span className="text-primary">Features</span>
//               </h1>
//               <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet nemo expedita
...
//                 <img src="img/features-img.png" className="img-fluid w-100" style={{ objectFit: 'cover' }}
//                   alt="Img" />
//               </div>
//               <div className="col-xl-4">
//                 <div className="row gy-4 gx-0">
...
//           <div className="container py-5">
//             <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: 800 }}>
//               <h1 className="display-5 text-capitalize text-white mb-3">Cental<span className="text-primary">
//                 Process</span></h1>
//               <p className="mb-0 text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet
//                 nemo expedita asperiores commodi accusantium at cum harum, excepturi, quia tempora cupiditate!
...
//                   <p className="mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, dolorem!
//                   </p>
...
//           <div className="container py-5">
//             <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: 800 }}>
//               <h1 className="display-5 text-capitalize mb-3">Customer<span className="text-primary"> Suport</span>
//                 Center</h1>
//               <p className="mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut amet nemo expedita
//                 asperiores commodi accusantium at cum harum, excepturi, quia tempora cupiditate! Adipisci
//                 facilis modi quisquam quia distinctio,
...
//                       <a className="btn btn-square btn-light rounded-circle mx-1" href><i
